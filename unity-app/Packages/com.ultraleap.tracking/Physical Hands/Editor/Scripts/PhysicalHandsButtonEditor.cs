...
namespace Leap.PhysicalHands
{
    ...
    public class PhysicalHandsButtonEditor : CustomEditorBase<PhysicalHandsButton>
    {
        ...
        {
            var physicalHandsManager = Object.FindAnyObjectByType<PhysicalHandsManager>(FindObjectsInactive.Include);
            ...
            else if (Object.FindAnyObjectByType<GrabHelper>(FindObjectsInactive.Include) == null)
            {
